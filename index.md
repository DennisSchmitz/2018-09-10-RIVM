...
humandate: "Sept 10-11, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2018-09-11        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
helper: ["Tom van Wijk", "Paul Wackers", "Michael Visser"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="requirements">
  ...
  <a href="https://rivm-bioinformatics.github.io/2018-09-10-RIVM/setup">here</a>). They are also required to abide by
  {% if page.carpentry == "swc" %}
...
<b>All courses, code and examples will be shared after the course using this PLACEHOLDER link.</b>

<!--
<b>This is the schedule for the course with all code and examples: <a href="https://rivm-bioinformatics.github.io/2018-09-10-RIVM/schedule">schedule</a></b>
-->

<b>N.B. The actual schedule may vary slightly depending on the topics and exercises chosen by the intructors.</b>
...
<p id="collaborative_notes">
  <b>We will use this <a href="{{page.collaborative_notes}}">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.</b>
</p>
{% endif %}
